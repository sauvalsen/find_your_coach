 ...
 */
final class Version20190520140407 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sport_user DROP FOREIGN KEY FK_FA4CF8B5A76ED395');
